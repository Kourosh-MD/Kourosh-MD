...
EN_PAGES = [
    EN_HEADER + '''
<section class="section"><h2>Professional Profile</h2><p class="lead">Computer Engineering student focused on Java backend development with Spring Boot and building practical skills through personal projects.</p><p>I have 1.5 years of experience in a technical work environment, following software and infrastructure project processes. My responsibilities centered on general systems work rather than direct professional software product development.</p><p>Current goal: secure a first professional opportunity as a Junior Java Developer. Long-term goal: expand my frontend skills and grow into a Full-Stack Developer.</p></section>
...
FA_PAGES = [
    FA_HEADER + '''
<section class="section"><h2>خلاصه حرفه‌ای</h2><p class="lead">دانشجوی مهندسی کامپیوتر و متمرکز بر یادگیری توسعه Java Backend با Spring Boot و کسب مهارت عملی از طریق پروژه‌های شخصی هستم.</p><p>دارای ۱.۵ سال سابقه فعالیت در یک محیط فنی و آشنایی نزدیک با فرایندهای پروژه‌های نرم‌افزاری و زیرساختی هستم. مسئولیت‌های من بیشتر شامل امور عمومی سیستمی بوده و نقش مستقیمی در توسعه حرفه‌ای محصولات نرم‌افزاری نداشته‌ام.</p><p>هدف فعلی من شروع فعالیت به عنوان Junior Java Developer است. در آینده قصد دارم مهارت‌های Frontend خود را توسعه دهم و به یک Full-Stack Developer تبدیل شوم.</p></section>
