...
EN_PAGES = [
    EN_HEADER + '''
<section class="section"><h2>Professional Profile</h2><p class="lead">Computer Engineering student focused on learning Java backend development with Spring Boot and building practical skills through personal projects.</p><p>I have 1.5 years of experience in a technical work environment, following software and infrastructure project processes. My responsibilities centered on general systems work rather than direct professional software product development.</p><p>Career goal: secure a first professional opportunity as a Junior Java Developer and grow in backend development, API design and maintainable software.</p></section>
...
<div class="grid-2"><section class="card"><h2>Education</h2><h3>Computer Engineering - In Progress</h3><p>Islamic Azad University<br>Tehran, Iran</p></section><section class="card"><h2>Core Direction</h2><div class="pill-row"><span class="pill">Java</span><span class="pill">Spring Boot</span><span class="pill">REST APIs</span><span class="pill">PostgreSQL</span><span class="pill">Maven</span><span class="pill">Linux</span></div></section></div>
''',
    EN_HEADER + '''
...
FA_PAGES = [
    FA_HEADER + '''
<section class="section"><h2>خلاصه حرفه‌ای</h2><p class="lead">دانشجوی مهندسی کامپیوتر در دانشگاه آزاد اسلامی و در حال یادگیری توسعه Backend با Java و Spring Boot هستم.</p><p>دارای ۱.۵ سال سابقه فعالیت در یک محیط فنی و آشنایی نزدیک با فرایندهای پروژه‌های نرم‌افزاری و زیرساختی هستم. مسئولیت‌های من بیشتر شامل امور عمومی سیستمی بوده و نقش مستقیمی در توسعه حرفه‌ای محصولات نرم‌افزاری نداشته‌ام.</p><p>هدف حرفه‌ای من شروع فعالیت به عنوان Junior Java Developer و رشد در زمینه Java Backend، طراحی API و تولید نرم‌افزارهای قابل نگهداری است.</p></section>
...
<div class="grid-2"><section class="card"><h2>تحصیلات</h2><h3>مهندسی کامپیوتر - در حال تحصیل</h3><p>دانشگاه آزاد اسلامی<br>تهران، ایران</p></section><section class="card"><h2>مسیر اصلی</h2><div class="pill-row"><span class="pill">Java</span><span class="pill">Spring Boot</span><span class="pill">REST APIs</span><span class="pill">PostgreSQL</span><span class="pill">Maven</span><span class="pill">Linux</span></div></section></div>
''',
    FA_HEADER + '''
