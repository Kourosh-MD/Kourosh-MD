...
EN_HEADER = '''
<header class="header"><div><h1>Kourosh Mansouri</h1><div class="role">Junior Full-Stack Developer</div></div><div class="contact">Tehran, Iran<br>github.com/Kourosh-MD<br>linkedin.com/in/kourosh-mansouri-a6a1291b2</div></header>
'''

FA_HEADER = '''
<header class="header"><div><h1>کوروش منصوری</h1><div class="role">توسعه‌دهنده جونیور فول‌استک</div></div><div class="contact">Tehran, Iran<br>github.com/Kourosh-MD<br>linkedin.com/in/kourosh-mansouri-a6a1291b2</div></header>
'''

EN_PAGES = [
    EN_HEADER + '''
<section class="section"><h2>Professional Profile</h2><p class="lead">Computer Engineering student focused on becoming a full-stack developer, with Java and Spring Boot on the backend and JavaScript and Next.js on the frontend.</p><p>I have 1.5 years of experience in a technical work environment, following software and infrastructure project processes. My responsibilities centered on general systems work rather than direct professional software product development.</p><p>Career goal: secure a first professional opportunity as a Junior Full-Stack Developer and grow in complete web application development, clean API design and maintainable software.</p></section>
<section class="section"><h2>Professional Experience</h2><div class="card accent"><h3>Noavaran Hoosh Kavan</h3><div class="meta">1.5 years</div><div class="grid-2"><ul><li>Designed, developed and maintained the company website.</li><li>Worked in Linux and Ubuntu environments.</li><li>Set up and configured VPN connectivity.</li><li>Implemented automation for recurring technical tasks.</li></ul><ul><li>Configured and troubleshot networking.</li><li>Diagnosed software and operating-system problems.</li><li>Worked with project-specific infrastructure tools.</li><li>Supported general technical and operational tasks.</li></ul></div><p>This was not a direct software-development role, but it provided close exposure to software and infrastructure workflows while building practical problem-solving and troubleshooting skills.</p></div></section>
<div class="grid-2"><section class="card"><h2>Education</h2><h3>Computer Engineering - In Progress</h3><p>Islamic Azad University<br>Tehran, Iran</p></section><section class="card"><h2>Full-Stack Direction</h2><div class="pill-row"><span class="pill">Java</span><span class="pill">Spring Boot</span><span class="pill">REST APIs</span><span class="pill">PostgreSQL</span><span class="pill">JavaScript</span><span class="pill">Next.js</span></div></section></div>
''',
    EN_HEADER + '''
...
<section class="focus"><h2 style="color:#7ff5df">Career Direction</h2><p><strong>Target role:</strong> Junior Full-Stack Developer</p><p class="tagline">Java → Spring Boot → REST APIs → PostgreSQL → JavaScript → Next.js</p><p>Continuing parallel growth in software architecture, Linux, Docker, networking and AI/ML.</p></section>
''',
]

FA_PAGES = [
    FA_HEADER + '''
<section class="section"><h2>خلاصه حرفه‌ای</h2><p class="lead">دانشجوی مهندسی کامپیوتر و در حال یادگیری توسعه Full-Stack با Java و Spring Boot در Backend و JavaScript و Next.js در Frontend هستم.</p><p>دارای ۱.۵ سال سابقه فعالیت در یک محیط فنی و آشنایی نزدیک با فرایندهای پروژه‌های نرم‌افزاری و زیرساختی هستم. مسئولیت‌های من بیشتر شامل امور عمومی سیستمی بوده و نقش مستقیمی در توسعه حرفه‌ای محصولات نرم‌افزاری نداشته‌ام.</p><p>هدف حرفه‌ای من شروع فعالیت به عنوان Junior Full-Stack Developer و رشد در توسعه کامل برنامه‌های وب، طراحی API و تولید نرم‌افزارهای قابل نگهداری است.</p></section>
<section class="section"><h2>تجربه کاری</h2><div class="card accent"><h3>نوآوران هوش کاوان</h3><div class="meta">۱.۵ سال</div><div class="grid-2"><ul><li>طراحی، توسعه و نگهداری وب‌سایت شرکت</li><li>فعالیت در محیط‌های Linux و Ubuntu</li><li>راه‌اندازی و پیکربندی VPN</li><li>پیاده‌سازی Automation برای وظایف فنی</li></ul><ul><li>تنظیم و عیب‌یابی Networking</li><li>رفع مشکلات نرم‌افزاری و سیستمی</li><li>کار با ابزارها و زیرساخت‌های متناسب با پروژه</li><li>انجام امور عمومی فنی و عملیاتی</li></ul></div><p>این موقعیت، نقش مستقیم توسعه نرم‌افزار نبود؛ اما باعث آشنایی نزدیک با فرایندهای نرم‌افزاری و زیرساختی و کسب تجربه عملی در حل مسئله و عیب‌یابی سیستم‌ها شد.</p></div></section>
<div class="grid-2"><section class="card"><h2>تحصیلات</h2><h3>مهندسی کامپیوتر - در حال تحصیل</h3><p>دانشگاه آزاد اسلامی<br>تهران، ایران</p></section><section class="card"><h2>مسیر Full-Stack</h2><div class="pill-row"><span class="pill">Java</span><span class="pill">Spring Boot</span><span class="pill">REST APIs</span><span class="pill">PostgreSQL</span><span class="pill">JavaScript</span><span class="pill">Next.js</span></div></section></div>
''',
    FA_HEADER + '''
...
''',
    FA_HEADER + '''
<section class="section"><h2>مهارت‌های فنی</h2><div class="grid-2"><div class="card"><div class="skill-group"><h3>Core Java</h3><div class="skill-line">Syntax · OOP · Collections · Generics · Streams · Exception Handling · CRUD · معماری لایه‌ای · کدنویسی قابل نگهداری</div></div><div class="skill-group"><h3>JVM و Memory</h3><div class="skill-line">Heap و Stack · Garbage Collection · JVM Metrics · Heap Dump · Memory Leak · آشنایی مقدماتی با JVM Tuning</div></div><div class="skill-group"><h3>Backend و Database</h3><div class="skill-line">Spring Boot · REST · JDBC · PostgreSQL · Flyway · Transaction · Validation · Spring Security · Redis</div></div><div class="skill-group"><h3>Testing و Automation</h3><div class="skill-line">Backend Testing · Playwright · E2E · Request Logging · Health Check · Load Testing</div></div></div><div class="card"><div class="skill-group"><h3>DevOps و سیستم</h3><div class="skill-line">Linux · Ubuntu · Docker · Docker Compose · GitHub Actions · CI · VPN · Networking · Troubleshooting</div></div><div class="skill-group"><h3>توسعه وب</h3><div class="skill-line">HTML · CSS · JavaScript · Node.js · Next.js · نگهداری وب‌سایت · WordPress · طراحی RTL</div></div><div class="skill-group"><h3>ابزار و Workflow</h3><div class="skill-line">Git · GitHub · Maven · API Design · Debugging · Documentation · Request Correlation</div></div><div class="skill-group"><h3>AI، Prompt Engineering و Dify</h3><div class="skill-line">تعامل مؤثر با AI · طراحی Prompt · مدیریت بهینه Token · برنامه‌ریزی و تکمیل کامل وظایف · ساخت Chatbot با Dify · یادگیری فعال ML/DL</div></div></div></div></section>
...
<section class="focus"><h2 style="color:#7ff5df">مسیر حرفه‌ای</h2><p><strong>موقعیت هدف:</strong> Junior Full-Stack Developer</p><p class="tagline">Java ← Spring Boot ← REST APIs ← PostgreSQL ← JavaScript ← Next.js</p><p>ادامه رشد هم‌زمان در معماری نرم‌افزار، Linux، Docker، Networking و AI/ML.</p></section>
''',
]
