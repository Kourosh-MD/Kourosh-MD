...
EN_PAGES = [
    EN_HEADER + '''
<section class="section"><h2>Professional Profile</h2><p class="lead">Software developer with <strong>1.5 years of hands-on professional experience</strong>, currently focused on Java backend development with Spring Boot.</p><p>Strong foundation in Core Java, object-oriented programming, Collections, Generics, Streams, exception handling, JVM concepts, PostgreSQL and JDBC. Practical experience also includes Linux administration, VPN configuration, automation, networking and web development, with an ongoing interest in AI and machine learning.</p><p>Career goal: join a software engineering team as a Junior Java Developer and grow in backend development, API design and maintainable software.</p></section>
<section class="section"><h2>Professional Experience</h2><div class="card accent"><h3>Noavaran Hoosh Kavan</h3><div class="meta">Technical and Software Role · 1.5 years - Present</div><div class="grid-2"><ul><li>Designed, developed and maintained the company website.</li><li>Worked in Linux and Ubuntu environments.</li><li>Configured and maintained VPN connectivity.</li><li>Implemented automation for recurring technical tasks.</li></ul><ul><li>Performed networking configuration and troubleshooting.</li><li>Diagnosed software and operating-system problems.</li><li>Worked with project-specific tools and infrastructure.</li><li>Supported technical operations beyond software development.</li></ul></div><p>This experience built practical problem-solving ability, confidence in real working environments and the capacity to respond to unfamiliar technical issues.</p></div></section>
<div class="grid-2"><section class="card"><h2>Education</h2><h3>Computer Science - In Progress</h3><p>Islamic Azad University<br>Tehran, Iran</p></section><section class="card"><h2>Core Direction</h2><div class="pill-row"><span class="pill">Java</span><span class="pill">Spring Boot</span><span class="pill">REST APIs</span><span class="pill">PostgreSQL</span><span class="pill">Git</span><span class="pill">Linux</span></div></section></div>
''',
    EN_HEADER + '''
...
''',
    EN_HEADER + '''
<section class="section"><h2>Technical Competencies</h2><div class="grid-2"><div class="card"><div class="skill-group"><h3>Core Java</h3><div class="skill-line">Java syntax · OOP · Collections · Generics · Streams · Exceptions · CRUD · layered design · maintainable code</div></div><div class="skill-group"><h3>JVM and Memory</h3><div class="skill-line">Heap and stack · garbage collection · JVM metrics · heap dumps · memory leaks · introductory JVM tuning</div></div><div class="skill-group"><h3>Backend and Database</h3><div class="skill-line">Spring Boot · REST · JDBC · PostgreSQL · Flyway · transactions · validation · Spring Security · Redis</div></div><div class="skill-group"><h3>Testing and Automation</h3><div class="skill-line">Backend testing · Playwright · end-to-end testing · request logging · health checks · load testing</div></div></div><div class="card"><div class="skill-group"><h3>DevOps and Systems</h3><div class="skill-line">Linux · Ubuntu · Docker · Docker Compose · GitHub Actions · CI · VPN · networking · troubleshooting</div></div><div class="skill-group"><h3>Web Development</h3><div class="skill-line">HTML · CSS · JavaScript · Node.js · Next.js · website maintenance · WordPress · RTL layouts</div></div><div class="skill-group"><h3>Tools and Workflow</h3><div class="skill-line">Git · GitHub · Maven · API design · debugging · documentation · request correlation</div></div><div class="skill-group"><h3>AI and Machine Learning</h3><div class="skill-line">Active learning interest in AI, machine learning and deep learning, with early practical exploration</div></div></div></div></section>
<section class="section"><h2>Professional Strengths</h2><div class="grid-2"><ul><li>Problem solving and technical troubleshooting</li><li>Fast, self-directed learning</li><li>Comfort with unfamiliar systems and tools</li><li>Understanding concepts beyond surface-level usage</li></ul><ul><li>Real-world operational awareness</li><li>Clear technical documentation</li><li>Interest in maintainable software</li><li>Commitment to continuous improvement</li></ul></div></section>
<section class="focus"><h2 style="color:#7ff5df">Career Direction</h2><p><strong>Target role:</strong> Junior Java Developer</p><p class="tagline">Java → Spring Boot → REST APIs → Databases → Software Architecture</p><p>Continuing parallel growth in Linux, Docker, networking and AI/ML.</p></section>
''',
]

FA_PAGES = [
    FA_HEADER + '''
<section class="section"><h2>خلاصه حرفه‌ای</h2><p class="lead">توسعه‌دهنده نرم‌افزار با <strong>۱.۵ سال تجربه کاری در محیط واقعی</strong> و تمرکز فعلی بر توسعه Backend با Java و Spring Boot.</p><p>دارای دانش خوب در Core Java، برنامه‌نویسی شیءگرا، Collections، Generics، Streams، مدیریت Exception، مفاهیم JVM و کار با PostgreSQL و JDBC. در کنار مسیر توسعه نرم‌افزار، تجربه عملی در Linux، مدیریت سیستم، VPN، Automation، Networking و توسعه وب دارم و به AI و Machine Learning نیز علاقه‌مند هستم.</p><p>هدف حرفه‌ای من ورود به یک تیم نرم‌افزاری به عنوان Junior Java Developer و توسعه مهارت‌ها در Java Backend، طراحی API و تولید نرم‌افزارهای قابل نگهداری است.</p></section>
<section class="section"><h2>تجربه کاری</h2><div class="card accent"><h3>نوآوران هوش کاوان</h3><div class="meta">فعالیت فنی و نرم‌افزاری · ۱.۵ سال تا کنون</div><div class="grid-2"><ul><li>طراحی، توسعه و نگهداری وب‌سایت شرکت</li><li>فعالیت در محیط‌های Linux و Ubuntu</li><li>راه‌اندازی و پیکربندی VPN</li><li>پیاده‌سازی Automation برای وظایف فنی</li></ul><ul><li>تنظیم و عیب‌یابی Networking</li><li>رفع مشکلات نرم‌افزاری و سیستمی</li><li>کار با ابزارها و زیرساخت‌های متناسب با پروژه</li><li>پشتیبانی و بهبود زیرساخت‌های کاری</li></ul></div><p>این تجربه باعث آشنایی عملی با حل مسئله، کار با سیستم‌های مختلف و مواجهه با مشکلات پیش‌بینی‌نشده در یک محیط حرفه‌ای شده است.</p></div></section>
<div class="grid-2"><section class="card"><h2>تحصیلات</h2><h3>علوم کامپیوتر - در حال تحصیل</h3><p>دانشگاه آزاد اسلامی<br>تهران، ایران</p></section><section class="card"><h2>مسیر اصلی</h2><div class="pill-row"><span class="pill">Java</span><span class="pill">Spring Boot</span><span class="pill">REST APIs</span><span class="pill">PostgreSQL</span><span class="pill">Git</span><span class="pill">Linux</span></div></section></div>
''',
    FA_HEADER + '''
...
''',
    FA_HEADER + '''
<section class="section"><h2>مهارت‌های فنی</h2><div class="grid-2"><div class="card"><div class="skill-group"><h3>Core Java</h3><div class="skill-line">Syntax · OOP · Collections · Generics · Streams · Exception Handling · CRUD · معماری لایه‌ای · کدنویسی قابل نگهداری</div></div><div class="skill-group"><h3>JVM و Memory</h3><div class="skill-line">Heap و Stack · Garbage Collection · JVM Metrics · Heap Dump · Memory Leak · آشنایی مقدماتی با JVM Tuning</div></div><div class="skill-group"><h3>Backend و Database</h3><div class="skill-line">Spring Boot · REST · JDBC · PostgreSQL · Flyway · Transaction · Validation · Spring Security · Redis</div></div><div class="skill-group"><h3>Testing و Automation</h3><div class="skill-line">Backend Testing · Playwright · E2E · Request Logging · Health Check · Load Testing</div></div></div><div class="card"><div class="skill-group"><h3>DevOps و سیستم</h3><div class="skill-line">Linux · Ubuntu · Docker · Docker Compose · GitHub Actions · CI · VPN · Networking · Troubleshooting</div></div><div class="skill-group"><h3>توسعه وب</h3><div class="skill-line">HTML · CSS · JavaScript · Node.js · Next.js · نگهداری وب‌سایت · WordPress · طراحی RTL</div></div><div class="skill-group"><h3>ابزار و Workflow</h3><div class="skill-line">Git · GitHub · Maven · API Design · Debugging · Documentation · Request Correlation</div></div><div class="skill-group"><h3>AI و Machine Learning</h3><div class="skill-line">علاقه و یادگیری فعال در AI، Machine Learning و Deep Learning و تجربه‌های اولیه عملی</div></div></div></div></section>
...
<section class="focus"><h2 style="color:#7ff5df">مسیر حرفه‌ای</h2><p><strong>موقعیت هدف:</strong> Junior Java Developer</p><p class="tagline">Java ← Spring Boot ← REST APIs ← Databases ← Software Architecture</p><p>ادامه رشد هم‌زمان در Linux، Docker، Networking و AI/ML.</p></section>
''',
]
