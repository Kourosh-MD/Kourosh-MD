...
EN_PAGES = [
    EN_HEADER + '''
<section class="section"><h2>Professional Profile</h2><p class="lead">Computer Engineering student focused on Java backend development with Spring Boot. I strengthen my backend expertise through personal projects using REST APIs, JDBC and PostgreSQL.</p><p>I have 1.5 years of experience in a technical work environment, following software and infrastructure project processes. My responsibilities centered on general systems work rather than direct professional software product development.</p><p>Current goal: secure a first professional opportunity as a Junior Java Developer and continue improving in backend architecture, clean API design and maintainable software.</p></section>
...
FA_PAGES = [
    FA_HEADER + '''
<section class="section"><h2>خلاصه حرفه‌ای</h2><p class="lead">دانشجوی مهندسی کامپیوتر و متمرکز بر توسعه Java Backend با Spring Boot هستم. مهارت‌های Backend خود را از طریق پروژه‌های شخصی با REST API، JDBC و PostgreSQL تقویت کرده‌ام.</p><p>دارای ۱.۵ سال سابقه فعالیت در یک محیط فنی و آشنایی نزدیک با فرایندهای پروژه‌های نرم‌افزاری و زیرساختی هستم. مسئولیت‌های من بیشتر شامل امور عمومی سیستمی بوده و نقش مستقیمی در توسعه حرفه‌ای محصولات نرم‌افزاری نداشته‌ام.</p><p>هدف فعلی من شروع فعالیت به عنوان Junior Java Developer و ادامه پیشرفت در معماری Backend، طراحی APIهای تمیز و تولید نرم‌افزارهای قابل نگهداری است.</p></section>
