...
.experience-group h4 { margin: 0 0 1.5mm; color: #405ea8; font-size: 9pt; letter-spacing: .04em; text-transform: uppercase; }
.experience-group + .experience-group { margin-top: 3mm; }
.experience-group ul { margin-top: 0; }
.experience-group li { margin-bottom: 1.1mm; font-size: 8.1pt; line-height: 1.35; }
.fa .experience-group h4 { font-size: 10pt; letter-spacing: 0; text-transform: none; }
.fa .experience-group + .experience-group { margin-top: 2.5mm; }
.fa .experience-group li { margin-bottom: .9mm; font-size: 8.7pt; line-height: 1.48; }
...
<section class="section"><h2>Professional Experience</h2><div class="card accent"><h3>Noavaran Hoosh Kavan</h3><div class="meta">2025 - Present</div><div class="grid-2 experience-grid"><div><div class="experience-group"><h4>Data and AI</h4><ul><li>Designed AI-assisted workflows for data ingestion from Excel and other sources.</li><li>Transformed, cleaned and validated data into database-ready formats.</li><li>Entered, updated and managed records and performed CRUD operations.</li><li>Automated recurring data-entry and processing workflows.</li></ul></div><div class="experience-group"><h4>AI Agents and Product Development</h4><ul><li>Built agents for AI token usage and service lifecycle management.</li><li>Designed workflows to coordinate agents and connected services.</li><li>Contributed to product development and product design.</li><li>Designed, developed and maintained the company website.</li></ul></div></div><div class="experience-group"><h4>Systems and Infrastructure</h4><ul><li>Worked in Linux and Ubuntu environments.</li><li>Set up and configured VPN connectivity.</li><li>Implemented automation for recurring technical tasks.</li><li>Configured and troubleshot networking.</li><li>Diagnosed software and operating-system problems.</li><li>Worked with project-specific infrastructure tools.</li><li>Supported general technical and operational tasks.</li></ul></div></div></div></section>
...
<section class="section"><h2>تجربه کاری</h2><div class="card accent"><h3>نوآوران هوش کاوان</h3><div class="meta">از سال ۱۴۰۴ تاکنون</div><div class="grid-2 experience-grid"><div><div class="experience-group"><h4>داده و AI</h4><ul><li>طراحی جریان‌های مبتنی بر AI برای ورود داده از Excel و سایر منابع</li><li>تبدیل، پاک‌سازی و اعتبارسنجی داده‌ها در قالب مناسب پایگاه داده</li><li>ثبت، به‌روزرسانی و مدیریت داده‌ها و انجام عملیات CRUD</li><li>خودکارسازی فرایندهای تکراری ورود و پردازش داده‌ها</li></ul></div><div class="experience-group"><h4>AI Agent و توسعه محصول</h4><ul><li>ساخت Agent برای مدیریت مصرف Token و چرخه سرویس‌ها</li><li>طراحی جریان‌های هماهنگ‌کننده Agentها و سرویس‌های مختلف</li><li>مشارکت در توسعه و دیزاین محصول</li><li>طراحی، توسعه و نگهداری وب‌سایت شرکت</li></ul></div></div><div class="experience-group"><h4>سیستم و زیرساخت</h4><ul><li>فعالیت در محیط‌های Linux و Ubuntu</li><li>راه‌اندازی و پیکربندی VPN</li><li>پیاده‌سازی Automation برای وظایف فنی</li><li>تنظیم و عیب‌یابی Networking</li><li>رفع مشکلات نرم‌افزاری و سیستمی</li><li>کار با ابزارها و زیرساخت‌های متناسب با پروژه</li><li>انجام امور عمومی فنی و عملیاتی</li></ul></div></div></div></section>
