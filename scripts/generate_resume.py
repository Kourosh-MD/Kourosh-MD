...
<defs>
  ...
  <linearGradient id="ai-panel" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#0d403c"/><stop offset=".6" stop-color="#123346"/><stop offset="1" stop-color="#26366b"/></linearGradient>
...
<g class="panel panel-5"><rect x="44" y="746" width="510" height="181" rx="18" fill="url(#ai-panel)" stroke="{MINT}" stroke-width="2"/><text x="66" y="779" class="section">AI &amp; Automation Strengths</text><text x="526" y="779" text-anchor="end" class="label">HIGH-IMPACT SKILLS</text>{additional_nodes}</g>
